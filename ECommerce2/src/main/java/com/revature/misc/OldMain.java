...
//                    System.out.println("Register");
                ...
                if (loggedInUser.getRole() == Role.USER){
                    ...
                    System.out.println("Press 3 to update an User");

                    String choice = scan.nextLine();
                    while (!(choice.equals("1") || choice.equals("2") || choice.equals("q") || choice.equals("3"))){
                    ...
                    if(choice.equals("1")){
                        ...
                        userController.updateUserHandler(loggedInUser.getUserId());
                    }
                    else {
                        loggedInUser = null;
                    }
